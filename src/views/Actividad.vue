...
export default {
  ...
  data: () => ({
    cuestionario: {
      tema: 'Fundamentos del análisis de datos y cliente digital.',
      titulo: 'Cuestionario',
      introduccion:
      ...
      preguntas: [
...

        {
          id: 9,
          texto:
            'Un KPI (Key performance indicator) mide el desempeño de objetivos específicos en campañas digitales.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
...

        {
          id: 15,
          texto:
            'El ROI digital permite medir la efectividad de las campañas en términos de retorno económico y optimización de recursos.',
          imagen: require('@/assets/actividad/imagen3.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
